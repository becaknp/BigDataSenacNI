...
def gerar_painel_boxplot(dados_array, medidas, titulo_boxplot='Boxplot da Distribuição de Dados', caminho_salvar=None):
    ...
    resumo = (
        ...
        f"  Média: ${medidas['media']:.2f}\n"
        f"  Mediana (Q2): ${medidas['mediana']:.2f}\n"
        f"\n"
        ...
        f"  Limite Superior (LS): ${medidas['limite_superior']:.2f}\n"
        f"  Limite Inferior (LI): ${medidas['limite_inferior']:.2f}\n"
        f"  Valor Máximo: ${medidas['max_valor']:.2f}\n"
        f"  Valor Mínimo: ${medidas['min_valor']:.2f}\n"
    )
